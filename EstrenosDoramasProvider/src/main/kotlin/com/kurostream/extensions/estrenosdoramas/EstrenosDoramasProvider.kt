package com.kurostream.extensions.estrenosdoramas
...
class EstrenosDoramasProvider : MainAPI() {
    ...
    override suspend fun load(url: String): LoadResponse {
        ...
        doc.select("div.post .lcp_catlist a").map {
        ...
        val tvtype = if (epi.isEmpty()) TvType.Movie else TvType.AsianDrama
    ...
    override suspend fun loadLinks(
        ...
        document.select("div.tab_container iframe").apmap { container ->
            ...
            loadExtractor(directlink, data, subtitleCallback) { l -> capturedLinks.add(l) }
            ...
            if (directlink.contains("reproducir14")) {
                ...
                regex.findAll(directlink).map {
                    ...
                    loadExtractor(extracteklink, data, subtitleCallback) { l -> capturedLinks.add(l) }
                }
            }
