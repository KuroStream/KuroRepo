package com.kurostream.extensions.cuevana
...
class CuevanaProvider : MainAPI() {
    ...
    override suspend fun loadLinks(
        ...
        app.get(data).document.select("li.open_submenu").apmap {
            it.select("li.clili").apmap {
                val iframe = fixUrl(it.attr("data-video").replaceFirst("^//".toRegex(), "https://"))
                loadExtractor(iframe, mainUrl, subtitleCallback) { l -> capturedLinks.add(l) }
            }
        }
